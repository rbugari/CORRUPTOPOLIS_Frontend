...
export const gameApi = {
  createPremiumCheckoutSession: () => api.post('/monetization/create-premium-checkout-session'),
  ...
  // Nuevo método para obtener configuración de publicidad
  getAdConfig: () => api.get('/game/ad-config'),
};
